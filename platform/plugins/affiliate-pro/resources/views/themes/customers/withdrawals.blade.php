...
@section('content')
    <div class="bb-customer-card-list affiliate-withdrawals-cards">
        ...
        @if($affiliate->status != \Botble\Base\Enums\BaseStatusEnum::PUBLISHED)
                ...
                <div class="bb-customer-card-body">
                    <form method="POST" action="{{ route('affiliate-pro.withdrawals.store') }}" id="withdrawal-form">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="available-balance">{{ trans('plugins/affiliate-pro::withdrawal.available_balance') }}</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="amount">{{ trans('plugins/affiliate-pro::withdrawal.enter_amount') }}</label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label mb-3">{{ trans('plugins/affiliate-pro::withdrawal.select_payment_method') }}</label>
                            <div class="payment-method-cards">
                                @if (is_plugin_active('paypal-payout'))
                                    <div class="payment-method-card" data-method="PayPal">
                                        <input type="radio" id="payment_paypal" name="payment_method" value="PayPal" class="payment-method-input" required>
                                        <label for="payment_paypal" class="payment-method-label">
                                            ...
                                            <div class="payment-method-info">
                                                ...
                                                <p class="payment-method-description">{{ trans('plugins/affiliate-pro::affiliate.paypal_description') }}</p>
                                            </div>
                                ...
                                <div class="payment-method-card" data-method="Bank Transfer">
                                    <input type="radio" id="payment_bank" name="payment_method" value="Bank Transfer" class="payment-method-input" required>
                                    <label for="payment_bank" class="payment-method-label">
                                        <div class="payment-method-icon">
                                            <x-core::icon name="ti ti-building-bank" />
                                        </div>
                                        <div class="payment-method-info">
                                            <h6 class="payment-method-title">Bank Transfer</h6>
                                            <p class="payment-method-description">{{ trans('plugins/affiliate-pro::affiliate.bank_description') }}</p>
                                        </div>
                                        <div class="payment-method-check">
                                            <x-core::icon name="ti ti-check" />
                                        </div>
                                ...
                                @if (is_plugin_active('stripe-connect'))
                                    <div class="payment-method-card" data-method="Stripe">
                                        <input type="radio" id="payment_stripe" name="payment_method" value="Stripe" class="payment-method-input" required>
                                        <label for="payment_stripe" class="payment-method-label">
                                            <div class="payment-method-icon">
                                                <x-core::icon name="ti ti-brand-stripe" />
                                            </div>
                                            <div class="payment-method-info">
                                                <h6 class="payment-method-title">Stripe</h6>
                                                <p class="payment-method-description">{{ trans('plugins/affiliate-pro::affiliate.stripe_description') }}</p>
                                            </div>
                                            <div class="payment-method-check">
                                                <x-core::icon name="ti ti-check" />
                                            </div>
                                ...
                                <div class="payment-method-card" data-method="Other">
                                    <input type="radio" id="payment_other" name="payment_method" value="Other" class="payment-method-input" required>
                                    <label for="payment_other" class="payment-method-label">
                                        <div class="payment-method-icon">
                                            <x-core::icon name="ti ti-dots" />
                                        </div>
                                        <div class="payment-method-info">
                                            <h6 class="payment-method-title">Other</h6>
                                            <p class="payment-method-description">{{ trans('plugins/affiliate-pro::affiliate.other_description') }}</p>
                                        </div>
                                        <div class="payment-method-check">
                                            <x-core::icon name="ti ti-check" />
                                        </div>
                        ...
                        <div class="form-group mb-3 payment-details-wrapper">
                            <label for="payment_details" id="payment-details-label">{{ trans('plugins/affiliate-pro::withdrawal.payment_details') }}</label>
                            ...
                            <small class="text-muted payment-details-help" id="bank-help" style="display: none;">{{ trans('plugins/affiliate-pro::affiliate.bank_help') }}</small>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="info-item">
                                                        ...
                                                        <span class="value">{{ $withdrawal->created_at->format('M d, Y') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
