...
@section('content')
    ...
    <div class="bb-customer-card-list affiliate-reports-cards">
        ...
        @if ($affiliate->status == \Botble\Base\Enums\BaseStatusEnum::PENDING)
        ...
        @if ($affiliate->status == \Botble\Base\Enums\BaseStatusEnum::PUBLISHED)
            ...
            <div class="bb-customer-card performance-overview-card">
                <div class="bb-customer-card-header">
                    ...
                    <div class="bb-customer-card-status">
                        <span class="badge bg-primary">{{ $startDate->format('M d') }} - {{ $endDate->format('M d') }}</span>
                    </div>
                </div>
                <div class="bb-customer-card-body">
                    <div class="row g-3">
                                    ...
                                    <div class="bb-customer-card-details">
                                        <div class="bb-customer-card-name">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="fw-bold">{{ $click->created_at->format('M d, Y H:i:s') }}</span>
                                                @if($click->converted)
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="info-item">
                                                            ...
                                                            <span class="value">{{ $commission->created_at->format('M d, Y') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
