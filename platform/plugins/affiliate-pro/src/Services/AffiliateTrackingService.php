...
class AffiliateTrackingService
{
    ...
    public function handleAffiliateTracking(Request $request, string $affiliateCode): void
    {
        ...
        Cookie::queue(self::COOKIE_NAME, $affiliateCode, $cookieLifetime * 1440); // Convert days to minutes
    ...
    {
        // Get location data from IP (simplified version)
     ...
     * This is a simplified version. In a real application, you would use a proper IP geolocation service.
     */
    ...
    {
        // Mark all unconverted clicks from this affiliate in the last 24 hours as converted
